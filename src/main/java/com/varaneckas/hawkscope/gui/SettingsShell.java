 ...
 */
public class SettingsShell extends org.eclipse.swt.widgets.Dialog {

    private static final Log log = LogFactory.getLog(SettingsShell.class);
    ...
    public SettingsShell(Shell parent, int style) {
        super(parent, style);
    }
